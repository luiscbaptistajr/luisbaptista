    ...
    <footer>      
      <section className="w-full">
        <div className="mx-24 my-auto contact-section">
          ...
          <p className="display-text text-center px-80 mb-24">Let's do something amazing! Feel free to get in touch through my LinkedIn. <br />I am always open to discussing new projects, creative ideas or opportunities to be part of your visions. <br /><br /><br /><Link className="btn-green" to="mailto:luiscbaptistajr@gmail.com">Contact Me</Link></p>
