  ...
  return (
    <section className="w-full hero-section">
      <div className="mx-24 my-auto grid grid-cols-6 gap-4">
          ...
          <img className="profile" src="https://placehold.co/150x150" alt="" />
