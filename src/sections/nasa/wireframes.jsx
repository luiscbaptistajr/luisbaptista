        ...
        <div className="mx-24 my-auto grid grid-cols-2 gap-4 education-section">
          ...
          <div className="col-start-2 course-detail">
            <div>
              ...
              <p>I am taking up a Post-Degree Diploma program specializing in the Web and Mobile App, Designer Stream. In an era where digital experiences shape the way we interact and engage, this stream offers an unparalleled opportunity to craft intuitive, visually stunning, and user-centric interfaces that transcend boundaries.</p>
